...
(function (I, ea) {
    ...
    function zi(a, b, c, d, e) {
        switch (b) {
            ...
            case "gotpointercapture":
                return (
                    (f = e.pointerId),
                    Fb.set(f, Gb(Fb.get(f) || null, a, b, c, d, e)),
                    !0
                );
        }
        return !1;
    ...
    function Ib(a, b) {
        a.blockedOn === b &&
            ((a.blockedOn = null), Rd || ((Rd = !0), $f(ag, Ci)));
    }
    function bg(a) {
        if (0 < fa.length) {
            Ib(fa[0], a);
    ...
    function pe(a, b, c, d) {
        ...
        "function" === typeof f &&
            (Lc(a, b, f, c), (e.state = a.memoizedState));
                ...
                switch (a.tag) {
                    ...
                    case 0:
                        throw (
                            ((a = a.type),
                            Error(
                                k(152, a.displayName || a.name || "Component")
                            ))
                        );
                }
            return c(a, d);
    ...
    function De(a) {
        if (Wa) {
            ...
            if (b) {
                ...
                (a.effectTag = (a.effectTag & -1025) | 2), (Wa = !1), (ra = a);
        }
    }
    function mh(a) {
        for (
    ...
    function Ie(a, b, c, d, e, f) {
        ...
        b.effectTag |= 1;
        null !== a && g
            ? ((b.child = wb(b, a.child, null, f)),
              (b.child = wb(b, null, h, f)))
            : T(a, b, h, f);
                ...
                if (null !== a && null != b.stateNode)
                    ...
                    if (Zc(b)) {
                        ...
                        switch (e) {
                            ...
                            case "option":
                                null != d.value &&
                                    a.setAttribute("value", "" + va(d.value));
                                break;
                            case "select":
        ...
        do {
            ...
            if (0 === (t.effectTag & 2048)) {
                ...
                null !== a &&
                    ...
                    null !== t.lastEffect &&
                        (null !== a.lastEffect &&
                            (a.lastEffect.nextEffect = t.firstEffect),
                        ...
                        : ((u =
                          ...
                          u.getSelection &&
                              ...
                              n &&
                                  ...
                                  g > h
                                      ? (u.addRange(A),
                                        u.extend(q.node, q.offset))
                                      : (A.setEnd(q.node, q.offset),
                                        u.addRange(A))))));
                A = [];
                ...
                g
                    ? (xg &&
                          ...
                          (mb || g !== ua.compositionStart
                              ...
                              : ((Ba = d),
                                (ce =
                                    "value" in Ba ? Ba.value : Ba.textContent),
                                (mb = !0))),
                      (e = Tj.getPooled(g, b, c, d)),
                      f
                          ? (e.data = f)
                          : ((f = ug(c)), null !== f && (e.data = f)),
                      lb(e),
                      (f = e))
                    : (f = null);
                (a = Vj ? Oi(a, c) : Pi(a, c))
                    ? ((b = Uj.getPooled(ua.beforeInput, b, c, d)),
                      (b.data = a),
                      lb(b))
                    : (b = null);
